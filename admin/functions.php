...
function tambahPetugas($data)
{
    ...
    // query data
    $query = "INSERT INTO petugas VALUES ('', '$nama', '$jenis_kelamin', '$alamat', '$no_telp', '$password')";
...
function register($data)
{
    ...
    mysqli_query($conn, "INSERT INTO petugas VALUES ('', '$nama', '$jenis_kelamin', '$alamat', '$no_telp', '$password')");
    return mysqli_affected_rows($conn);
}
