                        ...
                        <table class="table col-12 text-center justify-content-center">
                            ...
                            <?php foreach ($ptg as $row) : ?>
                                <tbody class="table-striped">
                                    ...
                                    <td><?= $row["no_telp"]; ?></td>
                                    <td>
                                        <a href="edit-petugas.php?id= <?= $row["id"]; ?>"><button type="submit" class="btn btn-primary" style="margin-right: 5px;">Edit</button></a>
                                        <a href="hapus-petugas.php?id= <?= $row["id"]; ?> "><button type="submit" class="btn btn-danger" onclick="return confirm('Yakin datanya mau dihapus?')">hapus</button></a>
                                    </td>
                                </tbody>
                                <?php $i++; ?>
                            <?php endforeach; ?>
